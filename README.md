...
## Introduction
This repository is a ALX Holberton School Project. The school project consisted in writing a shell like `sh` (Bourne Shell) by Stephen Bourne , in `C`, using a limited number of standard library functions, so instead we used our own function that we rewrited over the past three month [Here.](https://github.com/ismailza/alx-low_level_programming)
...
`git clone https://github.com/ismailza/simple_shell.git`
